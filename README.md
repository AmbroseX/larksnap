...
> Chrome 扩展：飞书 / Lark 文档一键导出 **Markdown / PDF / HTML**、批量下载附件、离线缓存，还能把 Markdown **写回文档**；任意网页（含小红书笔记）**一键转 Markdown**、整页截图、AI 总结、解除复制限制；下载 **B 站 / 抖音 / TikTok** 视频。
